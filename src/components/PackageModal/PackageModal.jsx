        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={5}>
            <Box className="home-package-details">
              ...
              >
                <Link to="/tour-packages">Book Now</Link>
              </Button>
            </Box>
          </Grid>
              ...
              <Box className="tab-content">
                {activeTab === 0 && (
                  <Box className="overview-tab">
                    ...
                    <Typography variant="body1" paragraph>
                      {packageData.description} This carefully crafted tour
                      package offers a perfect blend of sightseeing, culture,
                      and relaxation. Explore the beauty and heritage of{" "}
                      {packageData.location} with our experienced guides who
                      will ensure you don't miss any important attractions.
                    </Typography>

                    <Typography variant="body1" paragraph>
                      The package includes comfortable accommodation, daily
                      breakfast, and transportation in air-conditioned vehicles.
                      You'll have ample time to explore the local markets, taste
                      authentic cuisine, and immerse yourself in the local
                      culture.
                    </Typography>
                ...
                {activeTab === 3 && (
                  <Box className="policies-tab">
                    ...
                    <Typography variant="body1" paragraph>
                      • Booking requires a 30% advance payment to confirm
                      reservation.
                      <br />
                      • Full payment must be made 7 days before the tour start
                      date.
                      <br />• Government-issued ID proof is required for all
                      travelers.
                    </Typography>
                    ...
                    <Typography variant="body1" paragraph>
                      • Cancellation 15+ days before departure: 90% refund
                      <br />
                      • Cancellation 8-14 days before departure: 50% refund
                      <br />
                      • Cancellation 4-7 days before departure: 25% refund
                      <br />• Cancellation within 3 days of departure: No refund
                    </Typography>
                    ...
                    <Typography variant="body1" paragraph>
                      ...
                      <br />
                      • Children 5-12 years: 50% of the adult price with extra
                      bed
                      <br />• Children above 12 years: Full adult price
                      applicable
                    </Typography>
                  </Box>
                )}
